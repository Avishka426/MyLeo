      ...
      <ScrollView contentContainerStyle={{ padding: 20 }} keyboardShouldPersistTaps="handled">
        ...
        <View style={{ flexDirection: 'row', gap: 10, marginBottom: 14 }}>
          {(['own', 'all'] as const).map((v) => {
            ...
            const label = v === 'own' ? 'Our District Only' : 'All Districts';
        ...
        {day && month && year && parseInt(month) >= 1 && parseInt(month) <= 12 ? (
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: colors.primaryLight + '44', borderRadius: radius.md, padding: 12, marginBottom: 8 }}>
